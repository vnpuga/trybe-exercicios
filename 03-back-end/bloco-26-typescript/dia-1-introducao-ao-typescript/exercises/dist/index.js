...
console.log(`Losango com diagonais iguais a 32cm e 18cm: ${Exercise.lozenge(32, 18)}cm²`);
console.log(`Losango com diagonais iguais a 200cm e 50cm: ${Exercise.lozenge(200, 50)}cm²`);
console.log(`Losango com diagonais iguais a 75cm e 25cm: ${Exercise.lozenge(75, 25)}cm²`);
